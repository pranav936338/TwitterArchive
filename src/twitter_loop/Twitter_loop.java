...
public class Twitter_loop {
    ...
    public void loadMenu() throws InterruptedException {
        ...
        while(i < 1)
        {
            ...
            cb.setOAuthConsumerKey("blTRg0mCZgLEzmT1NX6wsxb6H");
            cb.setOAuthConsumerSecret("2I38MTLqGY0MtI95E9vhLQuTlIBdlJsD9Eor6rxJolvA9tNkrE");
            cb.setOAuthAccessToken("1204214011-awr3fdoCpJBJGZhSrGn2ZK18EEOdo7eSvkMVedw");
            cb.setOAuthAccessTokenSecret("gU6gJJ9RlBIBNTF2iEv3j3bZPy9i9owfWmlb6RNDQpNsG");
